...
if ($result && $row = $result->fetch_assoc()) {
    ...
    if ($maxPaymentID) {
        ...
        $numericPart++;
        $paymentID = 'PAYEB' . str_pad($numericPart, 4, '0', STR_PAD_LEFT);
    } else {
...
$sql = "INSERT INTO income_payment_entirebus_booking (Payment_ID, User_ID, Email, CardName, CardNumber, ExpMonth, ExpYear, CVV, Amount, OTP, Status) VALUES (?,  ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";

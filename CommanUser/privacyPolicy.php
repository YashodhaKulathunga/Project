...
<body>
    ...
    <div class="terms-container">
        <div class="term-section">
          ...
          <h3 class="term-subtitle"> a. Personal Information:  </h3>
          <p>
           When you use JourneyEase, we may collect personal information such as your name, email address, phone number, and payment details.
          </p>
          <h3 class="term-subtitle">b. Usage Information: </h3>
          <p>
            We collect information about how you interact with our platform, including your IP address, device information, and browsing patterns.
          </p>
        </div>
        <div class="term-section">
          <h2><b>How We Use Your Information</b></h2>
          <h3 class="term-subtitle"> a. Booking and Services: </h3>
          <p>
           We use your information to facilitate bus ticket bookings, provide services, and improve the functionality of the JourneyEase platform.
          </p>
          <h3 class="term-subtitle">b. Communication: </h3>
          <p>
            We may use your contact information to send you booking confirmations, updates, and important information related to your use of JourneyEase.
          </p>
          <h3 class="term-subtitle">c. Personalization:  </h3>
          <p>
            To enhance your experience, we may use your information to personalize content and recommendations.
          </p>
        </div>
        <div class="term-section">
          <h2><b>Information Sharing</b></h2>
          <h3 class="term-subtitle">a. Service Providers: </h3>
          <p>
            We may share your information with third-party service providers to assist with the operation of the platform, including payment processing and data analytics.
          </p>
          <h3 class="term-subtitle">b. Legal Compliance: </h3>
          <p>
            We may disclose your information as required by law or when we believe such disclosure is necessary to protect our rights or comply with a judicial proceeding.
          </p>
        </div>
        <div class="term-section">
        ...
        <div class="term-section">
            ...
            <p>
                We use cookies and similar technologies to collect and track information about your usage of JourneyEase. You can manage your cookie preferences through your browser settings.
            </p>
           
        </div>
        <div class="term-section">
            <h2><b>Your Choices</b></h2>
            <h3 class="term-subtitle">a. Account Information: </h3>
            <p>
                 You can review and update your account information by logging into your JourneyEase account.
            </p>
            <h3 class="term-subtitle">b. Communication Preferences: </h3>
            <p>
                 You can manage your communication preferences by adjusting your account settings or unsubscribing from emails.
            </p>
          </div>
